...
// String
const myString: string = "Bonjour TypeScript";
...
// Symbol
const mySymbol: symbol = Symbol("identifiant");
console.log(`Symbol: ${mySymbol.toString()} (type: ${typeof mySymbol})`);

// BigInt
const myBigInt: bigint = 123456789012345678901234567890n;
...
let primitiveA: number = 10;
let primitiveB: number = primitiveA; // Copie de la valeur
...
// Object
const myObject: object = { name: "Alice", age: 30 };
...
// Function
const myFunction: Function = function() { return "Hello"; };
...
function modifierPrimitif(valeur: number): number {
    valeur = valeur * 2;
    console.log('Dans la fonction, valeur =', valeur);
    return valeur;
}

function modifierObjet(obj: { valeur: number }): void {
...
function incrementerCompteur(etat: typeof etatInitial): typeof etatInitial {
    return {
        ...etat,
...
function ajouterUtilisateur(etat: typeof etatInitial, nouvelUtilisateur: string): typeof etatInitial {
    return {
        ...etat,
...
function changerTheme(etat: typeof etatInitial, nouveauTheme: string): typeof etatInitial {
    return {
        ...etat,
        configuration: {
            ...etat.configuration,
...
function estPrimitif(valeur: any): boolean {
    const type = typeof valeur;
    return type !== "object" && type !== "function";
}

function estObjet(valeur: any): boolean {
