...
const copieSup1 = Object.assign({}, originalObj);
...
function incrementerCompteur(etat) {
    return Object.assign(Object.assign({}, etat), { compteur: etat.compteur + 1 });
}
function ajouterUtilisateur(etat, nouvelUtilisateur) {
    return Object.assign(Object.assign({}, etat), { utilisateurs: [...etat.utilisateurs, nouvelUtilisateur] });
}
function changerTheme(etat, nouveauTheme) {
    return Object.assign(Object.assign({}, etat), { configuration: Object.assign(Object.assign({}, etat.configuration), { theme: nouveauTheme }) });
}
