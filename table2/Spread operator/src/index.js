...
const profilComplet = Object.assign(Object.assign(Object.assign({}, infoPersonnelle), infoContact), { ville: "Paris" });
...
const configProd = Object.assign(Object.assign({}, configDefaut), { host: "api.production.com", ssl: true, port: 443 });
...
const { id, nom } = utilisateur, autresInfos = __rest(utilisateur, ["id", "nom"]);
console.log('ID:', id);
console.log('Nom:', nom);
...
const cloneSuperficiel = Object.assign({}, objetAvecTableau);
...
const cloneProfond = Object.assign(Object.assign({}, objetAvecTableau), { categories: [...objetAvecTableau.categories] // Clone le tableau aussi
 });
...
const contact = Object.assign(Object.assign({}, personne), { email: "jean.martin@example.com", adresse: Object.assign({}, adresse) });
...
const voitureModifiee = Object.assign(Object.assign({}, voiture), { couleur: "rouge", kilometrage: 15000 });
...
const objetFusionne = fusionnerObjets({ nom: "Test", id: 1 }, { actif: true, date: new Date() });
console.log('Objet fusionné:', objetFusionne);
console.log('\n=== PERFORMANCE ET CONSIDÉRATIONS ===');
// 18. Performance avec de gros tableaux
function mesurePerformance(nom, operation) {
