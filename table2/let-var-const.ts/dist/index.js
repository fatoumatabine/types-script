...
function demonstrateVar() {
    ...
    var hoistedVar; // Déclaration hissée
...
function demonstrateConst() {
    ...
    try {
        ...
        console.log('Erreur de réassignation:', error.message);
    }
}
demonstrateConst();
...
function scopeComparison() {
    ...
    try {
        ...
        console.log('Erreur de portée:', error.message);
    }
}
scopeComparison();
...
function hoistingDemo() {
    ...
    var varHoisted; // Déclaration hissée
...
function typesDemo() {
    ...
    let explicitString = "TypeScript";
    const explicitConstant = false;
    // Union types
    let unionType = "début";
    ...
    // Const assertions
    const literalArray = [1, 2, 3]; // readonly [1, 2, 3]
    const literalObject = {
        x: 10,
        y: 20
